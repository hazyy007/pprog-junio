...
/** @brief Número de representaciones textuales por comando. */
#define N_CMDT 2
/** @brief Número total de códigos de comando reconocidos. */
#define N_CMD 16
 ...
 */
typedef enum { NO_CMD = -1, UNKNOWN, EXIT, TAKE, DROP , ATTACK , CHAT, MOVE, INSPECT, RECRUIT, ABANDON, USE, OPEN, SAVE, LOAD, COLAB} CommandCode;
